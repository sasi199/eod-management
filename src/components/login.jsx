...
//               // Navigate to appropriate role-based page
//               switch (role) {
//                 case "Super Admin":
//                   navigate("/sidebar");
//                   break;
...
//               <button
//                 type="submit"
//                 className={`py-1 px-3 mt-9 font-bold text-white rounded-md transition ${
//                   loading ? "bg-gray-400 cursor-not-allowed" : "bg-orange-400 hover:bg-orange-500"
//                 }`}
//                 disabled={loading}
//               >
