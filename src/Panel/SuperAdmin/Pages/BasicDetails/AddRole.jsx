  ...
  const AddRole = () => {
    ...
    const permissionOptions = [
      ...
      "empCreateCheckbox", // New permission for creating checkboxes
      "empEditCheckbox"    // New permission for editing checkboxes
    ];
            ...
            <div className="pb-4">
              <p className="font capitalize text-orange-500 pb-2">
                {groupName.replace(/([a-z])([A-Z])/g, '$1 $2')}
                  ...
                  <div className="flex">
                {
                  Object.keys(permissionGroups[permissionGroup]).map((permission)=>{
    ...
    <InfoCircleOutlined
              ...
              onMouseEnter={() => {
                console.log(permissionGroups[groupName][permission], "permissions");
              }}
            />  
  </Popover>
